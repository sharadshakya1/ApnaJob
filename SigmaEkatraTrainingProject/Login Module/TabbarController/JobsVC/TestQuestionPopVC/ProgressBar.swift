...
class ProgressBar: UIView {
  ...
  @IBInspectable public lazy var foregroundCircleColor: UIColor = UIColor.gray

  @IBInspectable public lazy var startGradientColor: UIColor = UIColor.gray
  @IBInspectable public lazy var endGradientColor: UIColor = UIColor.gray
...
//
  ...
  override func draw(_ rect: CGRect) {
    ...
    let lineWidth = min(frame.size.width, frame.size.height) * 0.04
  ...
  private func createCircularLayer(strokeColor: CGColor, fillColor: CGColor, lineWidth: CGFloat) -> CAShapeLayer {
    ...
    let endAngle = 1 * CGFloat.pi + startAngle
