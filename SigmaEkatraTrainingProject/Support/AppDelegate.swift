...
// import GooglePlaces
// let signInConfig = GIDConfiguration.init(clientID: "654469710549-21d0e95d3qrgt67dv2j1pokum0esrb9o.apps.googleusercontent.com")

@main
class AppDelegate: UIResponder, UIApplicationDelegate {

// 654469710549-21d0e95d3qrgt67dv2j1pokum0esrb9o.apps.googleusercontent.com
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
       ...
       // GMSPlacesClient.provideAPIKey("AIzaSyD7_XDuvPwbU9tt9VPma-NMrHx_hmUIkcI")
        return true
    }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "SigmaEkatraTrainingProject")
